...
public class AdminPage extends JPanel {
        ...
        okButton.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent e) {
                ...
                try (FileWriter fw = new FileWriter("book.txt", true)) {
                    for (String bookDetail : writeBook) {
                        fw.write(bookDetail + "\n");
                    }
                    JOptionPane.showMessageDialog(okButton, "새 도서 정보가 저장되었습니다");
                } catch (Exception ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(okButton, "도서 정보 저장 중 오류가 발생했습니다", "오류", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    ...
    public static void main(String[] args) {
        ...
        AdminPage adminPage = new AdminPage(mPagePanel);
        mPagePanel.add(adminPage, BorderLayout.CENTER);
