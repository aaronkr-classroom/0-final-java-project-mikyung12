...
public class MainWindow extends JFrame {
    ...
    private void initContainer(String title, int x, int y, int width, int height) {
        ...
        mPagePanel.setLayout(new BorderLayout()); // Set layout manager
        add(mPagePanel);
    ...
    private void menuIntroduction() {
        ...
        bt6.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (mCart.mCartCount == 0) {
                    JOptionPane.showMessageDialog(bt6, "장바구니에 항목이 없습니다", "장바구니 항목 삭제", JOptionPane.ERROR_MESSAGE);
                } else {
                    mPagePanel.removeAll();
        ...
        bt7.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (mCart.mCartCount == 0) {
                    ...
                    mPagePanel.removeAll();
                    mPagePanel.add(new CartShippingPage(mPagePanel, mCart));
                    mPagePanel.revalidate();
                    mPagePanel.repaint();
                }
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new MainWindow("쇼핑몰 메인 창", 0, 0, 1000, 750);
            }
        });
    }
}